...
> **Note**: The original HLD specified DynamoDB for storing ingestion records. However, due to the use of RDS for matching and FHIR purposes, the decision was made to store this data in RDS as well.
...
- `landing/reference/onspd/202402/file.csv` → `bronze/reference/onspd/202402/file.csv`
